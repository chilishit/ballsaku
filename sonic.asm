...
GM_Level:
		;move.b  #1,($FFFFFFEA).w ;[Your mum] is a [MILF], dude
...
Level_ClrRam:
	...
	Level_ClrVars2:
		...
		move.b  #0,($FFFFFFEA).w ;[Your mum] is a [MILF], dude
		moveq	#0,d0
		move.w	#$47,d1
...
Level_Index:
		...
		; Ending
		dc.w Level_End-Level_Index, Level_GHZ1bg-Level_Index, byte_6A320-Level_Index
		dc.w Level_End-Level_Index, Level_GHZ1bg-Level_Index, byte_6A320-Level_Index
...
Level_GHZ1:	incbin	"levels\ghz1.bin"
		even
Level_GHZ1bg:   incbin "levels/chungus.bin"
        even
byte_68D70:	dc.b 0,	0, 0, 0
Level_GHZ2:	incbin	"levels\ghz2.bin"
		even
Level_GHZ2bg:   incbin "levels/amongus.bin"
        even
byte_68E3C:	dc.b 0,	0, 0, 0
Level_GHZ3:	incbin	"levels\ghz3.bin"
		even
Level_GHZ3bg:	incbin	"levels\ghzbg.bin"
		even
